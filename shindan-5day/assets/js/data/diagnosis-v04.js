/* diagnosis-v04.js : 診断設問のデータ正本（現在 v0.5）。
 *
 ...
 *
 * ★ 校正前の開発版。Q1〜Q20の順番・質問文・選択肢・測定軸・配点は
 *   v0.4から独自に変更しない。変更が要るときはCodex／あかりの判断を経て
 *   version を 0.5 へ上げる。
 */
(function (global) {
  'use strict';
  ...
  var PHASES = [
    ...
    { no: 2, questions: [5, 6, 7, 8], title: '頑張っているのに、なぜ？' },
  ...
  SC.diagnosisData = {
    ...
    sourceTitle: '診断設計書 v0.4｜感情曲線・短文化20問（Q8は§51で差し替え）',
    ...
    scoringSteps: [
      { doing: '20問の回答を読み込んでいます', done: '20問の回答を読み込みました' },
